...
import com.example.homework10.adapter.LaunchImproveAdapter;

public class LaunchImproveActivity extends AppCompatActivity {
    // 声明引导页面的图片数组
    private int[] lanuchImageArray = {R.drawable.cprimer,
            R.drawable.bczm, R.drawable.java, R.drawable.androidstudio};
