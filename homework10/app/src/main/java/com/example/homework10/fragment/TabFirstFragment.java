...
import com.example.homework10.ShoppingChannelActivity;
import com.example.homework10.TabLayoutActivity;
import com.example.homework10.TabThirdActivity;
import com.example.homework10.adapter.GoodsAdapter;
...
import com.example.homework10.bean.reGoodsInfo;
import com.example.homework10.constant.ImageList;
import com.example.homework10.utils.Utils;
...
public class TabFirstFragment extends Fragment implements BannerPager.BannerClickListener,SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mView = inflater.inflate(R.layout.index_layout, container, false);
    ...
    private void initRecyclerGrid() {
        ...
        // 构建一个市场列表的网格适配器
        RecyclerGridAdapter adapter = new RecyclerGridAdapter(mContext, reGoodsInfo.getDefaultGrid());
        // 设置网格列表的点击监听器
    ...
    private void initRecyclerStaggered() {
        ...
        // 构建一个服装列表的瀑布流适配器
        RecyclerStaggeredAdapter adapter = new RecyclerStaggeredAdapter(mContext, reGoodsInfo.getDefaultStag());
        // 设置瀑布流列表的点击监听器
        adapter.setOnItemClickListener(adapter);
        // 设置瀑布流列表的长按监听器
        adapter.setOnItemLongClickListener(adapter);
    ...
    public void onBannerClick(int position) {
        ...
        intent.putExtra("goods_id", (long) (position+1));
