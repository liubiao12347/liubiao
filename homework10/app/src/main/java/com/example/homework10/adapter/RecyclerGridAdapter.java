...
public class RecyclerGridAdapter extends RecyclerView.Adapter<ViewHolder> implements OnItemClickListener, OnItemLongClickListener{
    ...
    private ArrayList<reGoodsInfo> mGoodsArray;

    public RecyclerGridAdapter(Context context, ArrayList<reGoodsInfo> goodsArray) {
        mContext = context;
    ...
    public void onBindViewHolder(ViewHolder vh, final int position) {
        ...
        Log.d(TAG, String.valueOf(((ItemHolder) vh).iv_pic));
