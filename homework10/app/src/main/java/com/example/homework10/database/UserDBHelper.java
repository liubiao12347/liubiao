...
public class UserDBHelper extends SQLiteOpenHelper {
    ...
    private static final String DB_NAME = "user1.db"; // 数据库的名称
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String create_sql = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " ("
                ...
                + "states INTEGER NOT NULL," + "update_time VARCHAR NOT NULL"
    ...
    public ArrayList<UserInfo> query(String condition) {
        String sql = String.format("select rowid,_id,name,age,height,weight,states,update_time," +
        ...
        while (cursor.moveToNext()) {
            ...
            info.states = (cursor.getInt(6) == 0) ? false : true;
