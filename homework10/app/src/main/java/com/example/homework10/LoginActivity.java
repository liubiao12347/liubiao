...
import com.example.homework10.bean.UserInfo;
import com.example.homework10.database.UserDBHelper;
import com.example.homework10.utils.DateUtil;
import com.example.homework10.utils.ViewUtil;

public class LoginActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    private static final String TAG = "LoginActivity"; //Log提示信息
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Log.d(TAG, rb_password==null?"null":"nonull");
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"学生", "老师","18990058王友江"};
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.bt_forget) { // 点击了“忘记密码”按钮
            ...
            if (rb_password.isChecked()) { // 密码方式校验
                //Log.d(TAG, rb_password.isChecked()?"true":"false");
                // 根据手机号码到数据库中查询用户记录
    ...
    private void loginSuccess() {
        ...
        String desc = String.format("您的手机号码是%s，类型是%s。恭喜你通过登录验证，点击“确定”按钮进入商城",
