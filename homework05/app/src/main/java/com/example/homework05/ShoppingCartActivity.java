...
import com.example.homework05.bean.CartInfo;
import com.example.homework05.bean.GoodsInfo;
import com.example.homework05.database.CartDBHelper;
import com.example.homework05.database.GoodsDBHelper;
import com.example.homework05.util.SharedUtil;
import com.example.homework05.util.Utils;
...
public class ShoppingCartActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_shopping) { // 点击了菜单项“去商场购物”
            ...
            mCartGoods.clear();
            mGoodsMap.clear();
            Toast.makeText(this, "精灵球已清空", Toast.LENGTH_SHORT).show();
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_detail) { // 点击了菜单项“查看商品详情”
            ...
            Toast.makeText(this, "已从精灵球删除" + mGoodsMap.get(goods_id).name, Toast.LENGTH_SHORT).show();
